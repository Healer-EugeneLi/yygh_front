...
    <div class="app-container">
        ...
        <div class="el-toolbar">
            ...
            <div class="el-toolbar-body"style="justify-content: flex-start;">
                <a href="http://localhost:8202/admin/cmn/dict/exportDictData" target="_blank">
...
export default {
    ...
    data(){
        ...
        return{
            list:[],//数据字典列表数组
            listLoading:true,
            dialogImportVisible:false//默认设置没有弹窗
